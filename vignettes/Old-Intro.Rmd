...
![FastRet GUI main interface showing the train new model mode with file upload section and model training options](Old-Intro/01.png){width=70%}
...
![Boxplot showing cross-validation performance measures with R-squared and error metrics for the trained retention time model](Old-Intro/02.png){width=49%}
![Scatterplot of predicted versus actual retention times showing model fit quality with diagonal reference line](Old-Intro/03.png){width=49%}
...
![FastRet GUI in utilize model mode showing options for uploading models and entering SMILES for prediction](Old-Intro/04.png){width=80%}
...
![Scatterplot showing correlation between old and new retention times for model adjustment, with linear regression line](Old-Intro/05.png){width=49%}
