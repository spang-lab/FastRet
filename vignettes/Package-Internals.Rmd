...
Model training is implemented in the `train_model` function. It first tries out several different parameter values in cross validation, remembers the best parameter value and then uses this value to train a final model on the full dataset. For further details see the function documention of [train_model](https://spang-lab.github.io/FastRet/reference/train_frm.html).
